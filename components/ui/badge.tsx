  ...
  'inline-flex items-center whitespace-nowrap justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        warm: 'bg-amber-50 text-amber-800 border-amber-200/50',
    ...
    compoundVariants: [
      ...
      /* Light variants for warm and stone */
      {
        variant: 'warm',
        appearance: 'light',
        className: 'bg-amber-50 text-amber-800 border-amber-200/30',
      },
      {
        variant: 'stone',
        appearance: 'light',
        className: 'bg-stone-100 text-stone-700 border-stone-200/30',
      },
      /* Outline variants for warm and stone */
      {
        variant: 'warm',
        appearance: 'outline',
        className: 'bg-amber-50/50 text-amber-800 border-amber-200',
      },
      {
        variant: 'stone',
        appearance: 'outline',
        className: 'bg-stone-100/50 text-stone-700 border-stone-200',
      },
